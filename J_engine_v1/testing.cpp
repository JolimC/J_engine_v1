...
void Testing::TestCases() {
	...
	assert(MirrorBB(C_WP_ATTACKS_1) == gp1.PawnAttacks(p1->wp_, gp1.parent_white_info_));
	assert(MirrorBB(0xA00000ULL) == gp1.KnightAttacks(1, gp1.parent_white_info_));
	assert(MirrorBB(0x50000ULL) == gp1.KnightAttacks(6, gp1.parent_white_info_));
	assert(MirrorBB(0ULL) == gp1.BishopAttacks(2, gp1.parent_white_info_));
	assert(MirrorBB(0ULL) == gp1.BishopAttacks(5, gp1.parent_white_info_));
	assert(MirrorBB(0ULL) == gp1.RookAttacks(0, gp1.parent_white_info_));
	assert(MirrorBB(0ULL) == gp1.RookAttacks(7, gp1.parent_white_info_));
	assert(MirrorBB(0ULL) == gp1.QueenAttacks(3, gp1.parent_white_info_));
	assert(MirrorBB(0ULL) == gp1.KingAttacks(gp1.parent_white_info_));
	assert(MirrorBB(0xFF0000ULL) == gp1.AttackSquares(gp1.parent_white_info_));
	...
	assert(MirrorBB(0x804020100800ULL) == gp2.BishopAttacks(5, gp2.parent_white_info_));
	assert(MirrorBB(0ULL) == gp2.RookAttacks(0, gp2.parent_white_info_));
	assert(MirrorBB(0x2ULL) == gp2.RookAttacks(7, gp2.parent_white_info_));
	...
	assert(MirrorBB(C_WP_ATTACKS_3) == gp3.PawnAttacks(p3->wp_, gp3.parent_white_info_));
	assert(MirrorBB(0x5088000840ULL) == gp3.KnightAttacks(18, gp3.parent_white_info_));
	assert(MirrorBB(0x1000ULL) == gp3.BishopAttacks(2, gp3.parent_white_info_));
	assert(MirrorBB(0x804020100800ULL) == gp3.BishopAttacks(5, gp3.parent_white_info_));
	assert(MirrorBB(0x40ULL) == gp3.RookAttacks(0, gp3.parent_white_info_));
	assert(MirrorBB(0x2ULL) == gp3.RookAttacks(7, gp3.parent_white_info_));
	assert(MirrorBB(0x102141800ULL) == gp3.QueenAttacks(3, gp3.parent_white_info_));
	assert(MirrorBB(0x1C00ULL) == gp3.KingAttacks(gp3.parent_white_info_));
	assert(MirrorBB(0x807BAAD71C42ULL) == gp3.AttackSquares(gp3.parent_white_info_));
	...
	assert(MirrorBB(C_WP_ATTACKS_4) == gp4.PawnAttacks(p4->wp_, gp4.parent_white_info_));
